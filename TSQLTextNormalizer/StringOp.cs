...
namespace TSQLTextNormalizer
{
    public class StringOp
    {
        ...
        //{
        //    HttpWebRequest webrequest = (HttpWebRequest)WebRequest.Create("http://rm-uat.angelone.in/SQLDOMEPARSER/api/Home/getNormalize?input=" + parameter.input + "&compatLevel=" + parameter.compatLevel.ToString() + "&caseSensitive=" + parameter.caseSensitive.ToString());
